...
The program uses three categories of assessments:
  ...
  2. The share of participating students who pass the Fundamentals of Engineering Examination (FE) (see @sec-fe)
  3. Graduation surveys and exit interviews (see @sec-exit)
  4. Student course evaluations (see @sec-eval)
  5. Statistics on student performance (see @sec-stats)
