...
Students rate each course on a five-point scale for each Aim. @fig-eval shows the Department averages for each course
...
The students also respond to questions about course organization, the helpfulness
of the instructor and materials, and other related topics. 
The responses to these questions help to identify instructor and course strengths
and weaknesses, which inform individual faculty development as well as status
and rank advancement decisions. This information is not used in program assessment.
