...
by advocating for students to meet regularly with the department academic advisor; monitoring
...
It should be noted that this data only include students who registered for an appointment with the advisor; students who
came to open hours without an appointment are not included.
...
The University tracks time to graduation for each student in number of
enrollments, or the number of semesters and terms that a student enrolls in
courses. This controls for mission deferments but not for transfers from other
institutions. The university target is for 75 percent of students to graduate within twelve enrollments, though
the university total of 61 percent is less than this target.
...
university in the 2017-18 through 2021-22 school years, meaning  a cohort of
five years of entering students, with the most recent students in the cohort entering four
complete academic years prior to the present.

![Enrollments to graduation for CE program students. Cohort entering BYU from 2017-18 through 2021-22 school years.](data/graduation/graduation-2017-2022.png){#fig-graduation}

For this period, 273 of 435 total students graduated within twelve enrollments,
for a share of **63 percent**. The time to graduation for each student is not
...
graduate within twelve enrollments for rolling five year aggregated cohorts. The most
recent 63% rate is a modest increase over the previous year, but there is an
overall negative trend.

```{r}
#| label: fig-graduation-longitudinal
#| fig-cap: Percent of CE students graduating within twelve enrollments, five year rolling enrollment cohorts.
#| fig-width: 7
#| fig-height: 4
#| out-width: 100%
#| out-height: 100%
...
# read in the data
graduation <- read_csv("data/graduation/cohorts_in_12.csv") 
